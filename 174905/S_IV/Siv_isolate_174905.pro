...
UVB_ind_Siv_174905 = UVB_ind_174905[coeff_arr_174905_Siv2_clean]
PRINT, UVB_ind_Siv_174905
PRINT, N_ELEMENTS(UVB_ind_Siv_174905) ;582
...
p_int_174905_Siv = zero[coeff_arr_174905_Siv2_clean]
sig_lw_174905_Siv = sig2[coeff_arr_174905_Siv2_clean]
lw_174905_Siv = two[coeff_arr_174905_Siv2_clean]
sig_p_int_174905_Siv = sig0[coeff_arr_174905_Siv2_clean]
;===============================================================================
...
limit_gamma_174905_Siv = gamma_174905
limit_wave0_174905_Siv = wave0_174905_Siv

limit_p_int_Siv = zero[coeff_arr_174905_Siv2_clean]
PRINT, "limit_p_int_Siv"
PRINT, N_ELEMENTS(limit_p_int_Siv) ;582
PRINT, limit_p_int_Siv

limit_sig_p_int_Siv = sig0[coeff_arr_174905_Siv2_clean]
PRINT, "limit_sig_p_int_Siv"
PRINT, N_ELEMENTS(limit_sig_p_int_Siv) ;582
PRINT, limit_sig_p_int_Siv

limit_lw_Siv = two[coeff_arr_174905_Siv2_clean]
PRINT, "limit_lw_Siv"
PRINT, N_ELEMENTS(limit_lw_Siv) ;582
PRINT, limit_lw_Siv

limit_sig_lw_Siv = sig2[coeff_arr_174905_Siv2_clean]
PRINT, "limit_sig_lw_Siv"
PRINT, N_ELEMENTS(limit_sig_lw_Siv) ;582
PRINT, limit_sig_lw_Siv

limit_vel_width_174905_Siv = (two[coeff_arr_174905_Siv2_clean]/limit_wave0_174905_Siv) * 3e5 * sqrt(2) ;exponential line width--km*s^-1
PRINT, "limit_vel_width_174905_Siv"
PRINT, N_ELEMENTS(limit_vel_width_174905_Siv) ;582
PRINT, limit_vel_width_174905_Siv

limit_velocity_174905_Siv = ((one[coeff_arr_174905_Siv2_clean]-limit_wave0_174905_Siv)/limit_wave0_174905_Siv) * 3e5 ;doppler shift--km*s^-1, pos-away, neg-toward
PRINT, "limit_velocity_174905_Siv"
PRINT, N_ELEMENTS(limit_velocity_174905_Siv) ;582
PRINT, limit_velocity_174905_Siv

;calculate total integrated intensity (TII)

It_S_174905 = (sqrt(2.0*!dpi)*p_int_174905_Siv*lw_174905_Siv) ;total integrated intensity 
PRINT, "It_S_174905"
PRINT, It_S_174905
PRINT, SIZE(It_S_174905) ;1D,582

;calculate integrated intensity uncertainty

int_int_unc_S_174905 = [2.0*!dpi*((p_int_174905_Siv)^2*(sig_lw_174905_Siv)^2+(lw_174905_Siv)^2*(sig_p_int_174905_Siv)^2)]^0.5
PRINT, "int_int_unc_S_174905"
PRINT, int_int_unc_S_174905
PRINT, SIZE(int_int_unc_S_174905) ;1D,582
...
neg = -0.5
SNR_S_174905 = (((sig_p_int_174905_Siv)^2/(p_int_174905_Siv)^2)+((sig_lw_174905_Siv)^2/(lw_174905_Siv)^2))^neg
PRINT, SNR_S_174905

PRINT, SIZE(SNR_S_174905) ;582
SNR2_S_174905 = WHERE((SNR_S_174905 LT 10000), count) ;removes infinity
...
SAVE, coeff_174905_Siv2, inst_unc_S_174905, sigma_coeff, sigma_coeff_arr, coeff_arr_174905_Siv2, It_S_174905, int_int_unc_S_174905, SNR_0_S_174905, SNR_S_174905, SNR2_S_174905, limit_vel_width_174905_Siv, limit_velocity_174905_Siv, p_int_174905_Siv, sig_lw_174905_Siv, lw_174905_Siv, sig_p_int_174905_Siv, UVB_ind_Siv_174905, FILENAME = sfname2
