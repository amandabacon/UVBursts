...
UVB_ind_Siv_114951 = UVB_ind_114951[coeff_arr_114951_Siv2_clean]
PRINT, UVB_ind_Siv_114951
PRINT, N_ELEMENTS(UVB_ind_Siv_114951) ;759
...
p_int_114951_Siv = zero[coeff_arr_114951_Siv2_clean]
sig_lw_114951_Siv = sig2[coeff_arr_114951_Siv2_clean]
lw_114951_Siv = two[coeff_arr_114951_Siv2_clean]
sig_p_int_114951_Siv = sig0[coeff_arr_114951_Siv2_clean]
;===============================================================================
...
limit_gamma_114951_Siv = gamma_114951
limit_wave0_114951_Siv = wave0_114951_Siv

limit_p_int_Siv = zero[coeff_arr_114951_Siv2_clean]
PRINT, "limit_p_int_Siv"
PRINT, N_ELEMENTS(limit_p_int_Siv) ;759
PRINT, limit_p_int_Siv

limit_sig_p_int_Siv = sig0[coeff_arr_114951_Siv2_clean]
PRINT, "limit_sig_p_int_Siv"
PRINT, N_ELEMENTS(limit_sig_p_int_Siv) ;759
PRINT, limit_sig_p_int_Siv

limit_lw_Siv = two[coeff_arr_114951_Siv2_clean]
PRINT, "limit_lw_Siv"
PRINT, N_ELEMENTS(limit_lw_Siv) ;759
PRINT, limit_lw_Siv

limit_sig_lw_Siv = sig2[coeff_arr_114951_Siv2_clean]
PRINT, "limit_sig_lw_Siv"
PRINT, N_ELEMENTS(limit_sig_lw_Siv) ;759
PRINT, limit_sig_lw_Siv

limit_vel_width_114951_Siv = (two[coeff_arr_114951_Siv2_clean]/limit_wave0_114951_Siv) * 3e5 * sqrt(2) ;exponential line width--km*s^-1
PRINT, "limit_vel_width_114951_Siv"
PRINT, N_ELEMENTS(limit_vel_width_114951_Siv) ;759
PRINT, limit_vel_width_114951_Siv

limit_velocity_114951_Siv = ((one[coeff_arr_114951_Siv2_clean]-limit_wave0_114951_Siv)/limit_wave0_114951_Siv) * 3e5 ;doppler shift--km*s^-1, pos-away, neg-toward
PRINT, "limit_velocity_114951_Siv"
PRINT, N_ELEMENTS(limit_velocity_114951_Siv) ;759
PRINT, limit_velocity_114951_Siv

;calculate total integrated intensity (TII)

It_S_114951 = (sqrt(2.0*!dpi)*p_int_114951_Siv*lw_114951_Siv) ;total integrated intensity 
PRINT, "It_S_114951"
PRINT, It_S_114951
PRINT, SIZE(It_S_114951) ;1D,759

;calculate integrated intensity uncertainty

int_int_unc_S_114951 = [2.0*!dpi*((p_int_114951_Siv)^2*(sig_lw_114951_Siv)^2+(lw_114951_Siv)^2*(sig_p_int_114951_Siv)^2)]^0.5
PRINT, "int_int_unc_S_114951"
PRINT, int_int_unc_S_114951
PRINT, SIZE(int_int_unc_S_114951) ;1D,759
...
neg = -0.5
SNR_S_114951 = (((sig_p_int_114951_Siv)^2/(p_int_114951_Siv)^2)+((sig_lw_114951_Siv)^2/(lw_114951_Siv)^2))^neg
PRINT, SNR_S_114951

PRINT, SIZE(SNR_S_114951) ;759
SNR2_S_114951 = WHERE((SNR_S_114951 LT 10000), count) ;removes infinity
...
SAVE, coeff_114951_Siv2, inst_unc_S_114951, sigma_coeff, sigma_coeff_arr, coeff_arr_114951_Siv2, It_S_114951, int_int_unc_S_114951, SNR_0_S_114951, SNR_S_114951, SNR2_S_114951, limit_vel_width_114951_Siv, limit_velocity_114951_Siv, p_int_114951_Siv, sig_lw_114951_Siv, lw_114951_Siv, sig_p_int_114951_Siv, UVB_ind_Siv_114951, FILENAME = sfname2
