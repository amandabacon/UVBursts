...
avg_prof_203906 = MEAN(MEAN(nspectraRast1394_203906, DIMENSION = 2, /NAN), DIMENSION = 2, /NAN)
...
velocity_203906 = ((coeff_arr_203906[1,*,*]-wave0_203906)/wave0_203906) * 3e5 ; from param_maps
