...
one = coeff_arr_050655_1_UV[1,*,*]
PRINT, one
PRINT, N_ELEMENTS(one) ;402
coeff_arr_050655_1_UV_clean = WHERE((one GT 1393.0) AND (one LT 1394.1), count, COMPLEMENT = non)
PRINT, SIZE(coeff_arr_050655_1_UV_clean) ;402
...
zero = coeff_arr_050655_1_UV[0,*,*] 
sig2 = sigma_coeff_arr[2,*,*] 
two = coeff_arr_050655_1_UV[2,*,*]
sig0 = sigma_coeff_arr[0,*,*]

p_int_050655_1 = zero[coeff_arr_050655_1_UV_clean]
sig_lw_050655_1 = sig2[coeff_arr_050655_1_UV_clean]
lw_050655_1 = two[coeff_arr_050655_1_UV_clean]
sig_p_int_050655_1 = sig0[coeff_arr_050655_1_UV_clean]
...
limit_vel_width_050655_1 = (two[coeff_arr_050655_1_UV_clean]/limit_wave0_050655_1) * 3e5 * sqrt(2) ;exponential line width--km*s^-1
...
limit_velocity_050655_1 = ((one[coeff_arr_050655_1_UV_clean]-limit_wave0_050655_1)/limit_wave0_050655_1) * 3e5 ;doppler shift--km*s^-1, pos-away, neg-toward
PRINT, "limit_velocity_050655_1"
PRINT, N_ELEMENTS(limit_velocity_050655_1) ;402
PRINT, limit_velocity_050655_1

;all velocity lines--40-1000 km/s
limit_all_e_dens_050655_1 = WHERE((limit_vel_width_050655_1 GE 40) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_050655_1 LT 1000) AND (limit_lw GE 0) AND (limit_sig_p_int GE 0) AND (limit_sig_lw GE 0) AND (ABS(limit_velocity_050655_1 LE (limit_gamma_050655_1/limit_wave0_050655_1) * 3e5)), COMPLEMENT = not_limit_all_e_dens_050655_1, count, /NULL)
PRINT, "limit_all_e_dens_050655_1--limit_vel_width"
PRINT, N_ELEMENTS(limit_vel_width_050655_1[limit_all_e_dens_050655_1])
PRINT, limit_vel_width_050655_1[limit_all_e_dens_050655_1] ;402

PRINT, "limit_all_e_dens_050655_1--limit_p_int"
PRINT, N_ELEMENTS(limit_p_int[limit_all_e_dens_050655_1])
PRINT, limit_p_int[limit_all_e_dens_050655_1] ;402

PRINT, "limit_all_e_dens_050655_1--limit_velocity"
PRINT, N_ELEMENTS(limit_velocity_050655_1[limit_all_e_dens_050655_1])
PRINT, ABS(limit_velocity_050655_1[limit_all_e_dens_050655_1]) ;402

PRINT, "limit_all_e_dens_050655_1--limit_lw"
PRINT, N_ELEMENTS(limit_lw[limit_all_e_dens_050655_1])
PRINT, limit_lw[limit_all_e_dens_050655_1] ;402

PRINT, "limit_all_e_dens_050655_1--limit_sig_p_int"
PRINT, N_ELEMENTS(limit_sig_p_int[limit_all_e_dens_050655_1])
PRINT, limit_sig_p_int[limit_all_e_dens_050655_1] ;402

PRINT, "limit_all_e_dens_050655_1--limit_sig_lw"
PRINT, N_ELEMENTS(limit_sig_lw[limit_all_e_dens_050655_1])
PRINT, limit_sig_lw[limit_all_e_dens_050655_1] ;402

;highest velocity lines--80-1000 km/s
limit_e_dens_050655_1 = WHERE((limit_vel_width_050655_1 GE 80) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_050655_1 LT 1000) AND (limit_lw GE 0) AND (limit_sig_p_int GE 0) AND (limit_sig_lw GE 0) AND (ABS(limit_velocity_050655_1 LE (limit_gamma_050655_1/limit_wave0_050655_1) * 3e5)), COMPLEMENT = not_limit_e_dens_050655_1, count, /NULL)
...
;variables saved in file below
;sfname_UV_limit = '/Users/physicsuser/Desktop/amandabacon/REU_CfA/data/detection/050655/raster1/limit_IT_UV_050655_1.sav'
;SAVE, limit_all_e_dens_050655_1, limit_e_dens_050655_1, limit_70_80_e_dens_050655_1, limit_60_70_e_dens_050655_1, limit_50_60_e_dens_050655_1, limit_40_50_e_dens_050655_1, limit_vel_width_050655_1, limit_velocity_050655_1, p_int, sig_lw, lw, sig_p_int, FILENAME = sfname_UV_limit

;limit_e_dens_050655_1, limit_It_Si_050655_1, limit_int_int_unc_Si_050655_1, limit_70_80_e_dens_050655_1, limit_70_80_It_Si_050655_1, limit_70_80_int_int_unc_Si_050655_1, limit_60_70_e_dens_050655_1, limit_60_70_It_Si_050655_1, limit_60_70_int_int_unc_Si_050655_1, limit_50_60_e_dens_050655_1, limit_50_60_It_Si_050655_1, limit_50_60_int_int_unc_Si_050655_1, limit_40_50_e_dens_050655_1, limit_40_50_It_Si_050655_1, limit_40_50_int_int_unc_Si_050655_1

;===============================================================================
;calculate total integrated intensity

It_Si_050655_1 = (sqrt(2.0*!dpi)*p_int_050655_1*lw_050655_1) ;total integrated intensity 
PRINT, "It_Si_050655_1"
PRINT, It_Si_050655_1
PRINT, SIZE(It_Si_050655_1) ;1D,402

;calculate integrated intensity uncertainty

int_int_unc_Si_050655_1 = [2.0*!dpi*((p_int_050655_1)^2*(sig_lw_050655_1)^2+(lw_050655_1)^2*(sig_p_int_050655_1)^2)]^0.5
PRINT, "int_int_unc_Si_050655_1"
PRINT, int_int_unc_Si_050655_1
PRINT, SIZE(int_int_unc_Si_050655_1) ;1D,402

;save parameters from FOR loop

sfname_UV = '/Users/physicsuser/Desktop/amandabacon/REU_CfA/data/detection/050655/raster1/IT_UV_050655_1.sav'
SAVE, coeff_050655_1_UV, inst_unc_Si_050655_1, sigma_coeff, sigma_coeff_arr, coeff_arr_050655_1_UV, It_Si_050655_1, int_int_unc_Si_050655_1, limit_vel_width_050655_1, limit_velocity_050655_1, p_int_050655_1, sig_lw_050655_1, lw_050655_1, sig_p_int_050655_1, FILENAME = sfname_UV
...
limit_byte_scale_050655_1[UVB_ind_050655_1[limit_e_dens_050655_1]] = 255
...
limit_70_80_byte_scale_050655_1[UVB_ind_050655_1[limit_70_80_e_dens_050655_1]] = 255
...
limit_60_70_byte_scale_050655_1[UVB_ind_050655_1[limit_60_70_e_dens_050655_1]] = 255
...
limit_50_60_byte_scale_050655_1[UVB_ind_050655_1[limit_50_60_e_dens_050655_1]] = 255
...
limit_40_50_byte_scale_050655_1[UVB_ind_050655_1[limit_40_50_e_dens_050655_1]] = 255
