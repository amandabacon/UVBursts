...
p_int = zero[coeff_arr_050655_Siv2_clean]
sig_lw = sig2[coeff_arr_050655_Siv2_clean]
lw = two[coeff_arr_050655_Siv2_clean]
sig_p_int = sig0[coeff_arr_050655_Siv2_clean]
;===============================================================================
...
It_S_050655 = (sqrt(2.0*!dpi)*p_int*lw) ;total integrated intensity 
PRINT, "It_S_050655"
PRINT, It_S_050655
...
int_int_unc_S_050655 = [2.0*!dpi*((p_int)^2*(sig_lw)^2+(lw)^2*(sig_p_int)^2)]^0.5
...
neg = -0.5
SNR_S_050655 = (((sig_p_int)^2/(p_int)^2)+((sig_lw)^2/(lw)^2))^neg
PRINT, SNR_S_050655

PRINT, SIZE(SNR_S_050655) ;246
SNR2_S_050655 = WHERE((SNR_S_050655 LT 100), count) ;removes infinity
...
SAVE, coeff_050655_Siv2, inst_unc_S_050655, sigma_coeff, sigma_coeff_arr, coeff_arr_050655_Siv2, It_S_050655, int_int_unc_S_050655, SNR_0_S_050655, SNR_S_050655, SNR2_S_050655, limit_vel_width_050655_Siv, limit_velocity_050655_Siv, p_int, sig_lw, lw, sig_p_int, FILENAME = sfname2
