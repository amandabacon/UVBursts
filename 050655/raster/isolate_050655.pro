...
p_int = zero[coeff_arr_050655_UV_clean]
sig_lw = sig2[coeff_arr_050655_UV_clean]
lw = two[coeff_arr_050655_UV_clean]
sig_p_int = sig0[coeff_arr_050655_UV_clean]
...
;PRINT, "limit_It_Si_050655"
;PRINT, limit_It_Si_050655

;calculate integrated intensity uncertainty 80-1000 km/s

;limit_int_int_unc_Si_050655 = [2.0*!dpi*((limit_p_int[limit_e_dens_050655])^2*(limit_sig_lw[limit_e_dens_050655])^2+(limit_lw[limit_e_dens_050655])^2*(limit_sig_p_int[limit_e_dens_050655])^2)]^0.5
;PRINT, "limit_int_int_unc_Si_050655"
;PRINT, limit_int_int_unc_Si_050655

;calculate total integrated intensity 70-80 km/s

;limit_70_80_It_Si_050655 = (sqrt(2.0*!dpi)*limit_p_int[limit_70_80_e_dens_050655]*limit_lw[limit_70_80_e_dens_050655]) ;total integrated intensity 
;PRINT, "limit_70_80_It_Si_050655"
;PRINT, limit_70_80_It_Si_050655

;calculate integrated intensity uncertainty 70-80 km/s

;limit_70_80_int_int_unc_Si_050655 = [2.0*!dpi*((limit_p_int[limit_70_80_e_dens_050655])^2*(limit_sig_lw[limit_70_80_e_dens_050655])^2+(limit_lw[limit_70_80_e_dens_050655])^2*(limit_sig_p_int[limit_70_80_e_dens_050655])^2)]^0.5
;PRINT, "limit_70_80_int_int_unc_Si_050655"
;PRINT, limit_70_80_int_int_unc_Si_050655

;calculate total integrated intensity 60-70 km/s

;limit_60_70_It_Si_050655 = (sqrt(2.0*!dpi)*limit_p_int[limit_60_70_e_dens_050655]*limit_lw[limit_60_70_e_dens_050655]) ;total integrated intensity 
;PRINT, "limit_60_70_It_Si_050655"
;PRINT, limit_60_70_It_Si_050655

;calculate integrated intensity uncertainty 60-70 km/s

;limit_60_70_int_int_unc_Si_050655 = [2.0*!dpi*((limit_p_int[limit_60_70_e_dens_050655])^2*(limit_sig_lw[limit_60_70_e_dens_050655])^2+(limit_lw[limit_60_70_e_dens_050655])^2*(limit_sig_p_int[limit_60_70_e_dens_050655])^2)]^0.5
;PRINT, "limit_60_70_int_int_unc_Si_050655"
;PRINT, limit_60_70_int_int_unc_Si_050655

;calculate total integrated intensity 50-60 km/s

;limit_50_60_It_Si_050655 = (sqrt(2.0*!dpi)*limit_p_int[limit_50_60_e_dens_050655]*limit_lw[limit_50_60_e_dens_050655]) ;total integrated intensity 
;PRINT, "limit_50_60_It_Si_050655"
;PRINT, limit_50_60_It_Si_050655

;calculate integrated intensity uncertainty 50-60 km/s

;limit_50_60_int_int_unc_Si_050655 = [2.0*!dpi*((limit_p_int[limit_50_60_e_dens_050655])^2*(limit_sig_lw[limit_50_60_e_dens_050655])^2+(limit_lw[limit_50_60_e_dens_050655])^2*(limit_sig_p_int[limit_50_60_e_dens_050655])^2)]^0.5
