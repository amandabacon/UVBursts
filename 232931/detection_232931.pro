...
;PLOT, cut_232931 ;this plot shows the overscan that you should remove
...
avg_prof_232931 = MEAN(MEAN(nspectraRast1394_232931, DIMENSION = 2, /NAN), DIMENSION = 2, /NAN) ;/NAN tag because of 0 in exposure time
...
velocity_232931 = ((coeff_arr_232931[1,*,*]-wave0_232931)/wave0_232931) * 3e5 ; from param_maps--doppler shift
