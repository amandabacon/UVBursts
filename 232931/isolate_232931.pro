...
PRINT, 'TEST'
test = WHERE((limit_vel_width_232931 GE 0.0) AND (limit_vel_width_232931 LE 50.0), count)
...
limit_40_50_e_dens_232931 = WHERE((limit_vel_width_232931 GE 40.0) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_232931 LE 50.0) AND (limit_lw GE 0.0) AND (limit_sig_p_int GE 0.0) AND (limit_sig_lw GE 0.0) AND (ABS(limit_velocity_232931 LE (limit_gamma_232931/limit_wave0_232931) * 3e5)), COMPLEMENT = not_limit_40_50_e_dens_232931, count)
