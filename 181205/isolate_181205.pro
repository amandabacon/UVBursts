...
one = coeff_arr_181205_UV[1,*,*]
PRINT, N_ELEMENTS(one) ;388
coeff_arr_181205_UV_clean = WHERE((one GT 1393.0) AND (one LT 1394.5), count, COMPLEMENT = non)
PRINT, N_ELEMENTS(coeff_arr_181205_UV_clean) ;388
...
zero = coeff_arr_181205_UV[0,*,*] 
sig2 = sigma_coeff_arr[2,*,*] 
two = coeff_arr_181205_UV[2,*,*]
sig0 = sigma_coeff_arr[0,*,*]

p_int_181205 = zero[coeff_arr_181205_UV_clean]
sig_lw_181205 = sig2[coeff_arr_181205_UV_clean]
lw_181205 = two[coeff_arr_181205_UV_clean]
sig_p_int_181205 = sig0[coeff_arr_181205_UV_clean]
...
limit_vel_width_181205 = (two[coeff_arr_181205_UV_clean]/limit_wave0_181205) * 3e5 * sqrt(2) ;exponential line width--km*s^-1
...
limit_velocity_181205 = ((one[coeff_arr_181205_UV_clean]-limit_wave0_181205)/limit_wave0_181205) * 3e5 ;doppler shift--km*s^-1, pos-away, neg-toward
PRINT, "limit_velocity_181205"
PRINT, N_ELEMENTS(limit_velocity_181205) ;388
PRINT, limit_velocity_181205

;all velocity lines--40-1000 km/s
limit_all_e_dens_181205 = WHERE((limit_vel_width_181205 GE 40) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_181205 LT 1000) AND (limit_lw GE 0) AND (limit_sig_p_int GE 0) AND (limit_sig_lw GE 0) AND (ABS(limit_velocity_181205 LE (limit_gamma_181205/limit_wave0_181205) * 3e5)), COMPLEMENT = not_limit_all_e_dens_181205, count, /NULL)
PRINT, "limit_all_e_dens_181205--limit_vel_width"
PRINT, N_ELEMENTS(limit_vel_width_181205[limit_all_e_dens_181205])
PRINT, limit_vel_width_181205[limit_all_e_dens_181205] ;388

PRINT, "limit_all_e_dens_181205--limit_p_int"
PRINT, N_ELEMENTS(limit_p_int[limit_all_e_dens_181205])
PRINT, limit_p_int[limit_all_e_dens_181205] ;388

PRINT, "limit_all_e_dens_181205--limit_velocity"
PRINT, N_ELEMENTS(limit_velocity_181205[limit_all_e_dens_181205])
PRINT, ABS(limit_velocity_181205[limit_all_e_dens_181205]) ;388

PRINT, "limit_all_e_dens_181205--limit_lw"
PRINT, N_ELEMENTS(limit_lw[limit_all_e_dens_181205])
PRINT, limit_lw[limit_all_e_dens_181205] ;388

PRINT, "limit_all_e_dens_181205--limit_sig_p_int"
PRINT, N_ELEMENTS(limit_sig_p_int[limit_all_e_dens_181205])
PRINT, limit_sig_p_int[limit_all_e_dens_181205] ;388

PRINT, "limit_all_e_dens_181205--limit_sig_lw"
PRINT, N_ELEMENTS(limit_sig_lw[limit_all_e_dens_181205])
PRINT, limit_sig_lw[limit_all_e_dens_181205] ;388

;highest velocity lines--80-1000 km/s
limit_e_dens_181205 = WHERE((limit_vel_width_181205 GE 80) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_181205 LT 1000) AND (limit_lw GE 0) AND (limit_sig_p_int GE 0) AND (limit_sig_lw GE 0) AND (ABS(limit_velocity_181205 LE (limit_gamma_181205/limit_wave0_181205) * 3e5)), COMPLEMENT = not_limit_e_dens_181205, count, /NULL)
...
limit_70_80_e_dens_181205 = WHERE((limit_vel_width_181205 GE 70.0) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_181205 LT 80.0) AND (limit_lw GE 0.0) AND (limit_sig_p_int GE 0.0) AND (limit_sig_lw GE 0.0) AND (ABS(limit_velocity_181205 LE (limit_gamma_181205/limit_wave0_181205) * 3e5)), COMPLEMENT = not_limit_med_70_80_e_dens_181205, count, /NULL)
...
limit_60_70_e_dens_181205 = WHERE((limit_vel_width_181205 GE 60.0) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_181205 LT 70.0) AND (limit_lw GE 0.0) AND (limit_sig_p_int GE 0.0) AND (limit_sig_lw GE 0.0) AND (ABS(limit_velocity_181205 LE (limit_gamma_181205/limit_wave0_181205) * 3e5)), COMPLEMENT = not_limit_60_70_e_dens_181205, count, /NULL)
...
;SAVE, limit_all_e_dens_181205, limit_e_dens_181205, limit_70_80_e_dens_181205, limit_60_70_e_dens_181205, limit_50_60_e_dens_181205, limit_40_50_e_dens_181205, limit_vel_width_181205, limit_velocity_181205, p_int, sig_lw, lw, sig_p_int, FILENAME = sfname_UV_limit

;limit_e_dens_181205, limit_It_Si_181205, limit_int_int_unc_Si_181205, limit_70_80_e_dens_181205, limit_70_80_It_Si_181205, limit_70_80_int_int_unc_Si_181205, limit_60_70_e_dens_181205, limit_60_70_It_Si_181205, limit_60_70_int_int_unc_Si_181205, limit_50_60_e_dens_181205, limit_50_60_It_Si_181205, limit_50_60_int_int_unc_Si_181205, limit_40_50_e_dens_181205, limit_40_50_It_Si_181205, limit_40_50_int_int_unc_Si_181205

;===============================================================================
;calculate total integrated intensity

It_Si_181205 = (sqrt(2.0*!dpi)*p_int_181205*lw_181205) ;total integrated intensity 
PRINT, "It_Si_181205"
PRINT, It_Si_181205
PRINT, SIZE(It_Si_181205) ;1D,388

;calculate integrated intensity uncertainty

int_int_unc_Si_181205 = [2.0*!dpi*((p_int_181205)^2*(sig_lw_181205)^2+(lw_181205)^2*(sig_p_int_181205)^2)]^0.5
PRINT, "int_int_unc_Si_181205"
PRINT, int_int_unc_Si_181205
PRINT, SIZE(int_int_unc_Si_181205) ;1D,388

;save parameters from FOR loop

sfname_UV = '/Users/physicsuser/Desktop/amandabacon/REU_CfA/data/detection/181205/IT_UV_181205.sav'
SAVE, coeff_181205_UV, inst_unc_Si_181205, sigma_coeff, sigma_coeff_arr, coeff_arr_181205_UV, It_Si_181205, int_int_unc_Si_181205, limit_vel_width_181205, limit_velocity_181205, p_int_181205, sig_lw_181205, lw_181205, sig_p_int_181205, FILENAME = sfname_UV
...
limit_byte_scale_181205[UVB_ind_181205[limit_e_dens_181205]] = 255
...
limit_70_80_byte_scale_181205[UVB_ind_181205[limit_70_80_e_dens_181205]] = 255
...
limit_60_70_byte_scale_181205[UVB_ind_181205[limit_60_70_e_dens_181205]] = 255
...
limit_50_60_byte_scale_181205[UVB_ind_181205[limit_50_60_e_dens_181205]] = 255
...
limit_40_50_byte_scale_181205[UVB_ind_181205[limit_40_50_e_dens_181205]] = 255
