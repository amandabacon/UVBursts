...
one = coeff_arr_052046_UV[1,*,*]
PRINT, N_ELEMENTS(one) ;2811
coeff_arr_052046_UV_clean = WHERE((one GT 1393.0) AND (one LT 1394.5), count, COMPLEMENT = non)
PRINT, N_ELEMENTS(coeff_arr_052046_UV_clean) ;2811
...
zero = coeff_arr_052046_UV[0,*,*] 
sig2 = sigma_coeff_arr[2,*,*] 
two = coeff_arr_052046_UV[2,*,*]
sig0 = sigma_coeff_arr[0,*,*]

p_int_052046 = zero[coeff_arr_052046_UV_clean]
sig_lw_052046 = sig2[coeff_arr_052046_UV_clean]
lw_052046 = two[coeff_arr_052046_UV_clean]
sig_p_int_052046 = sig0[coeff_arr_052046_UV_clean]
...
limit_vel_width_052046 = (two[coeff_arr_052046_UV_clean]/limit_wave0_052046) * 3e5 * sqrt(2) ;exponential line width--km*s^-1
PRINT, "limit_vel_width_052046"
PRINT, N_ELEMENTS(limit_vel_width_052046) ;2811
PRINT, limit_vel_width_052046

PRINT, 'TEST'
test = WHERE((limit_vel_width_052046 GE 0.0) AND (limit_vel_width_052046 LT 50.0), count)
PRINT, limit_vel_width_052046[test]
PRINT, MIN(limit_vel_width_052046[test]) ;40.041246

limit_velocity_052046 = ((one[coeff_arr_052046_UV_clean]-limit_wave0_052046)/limit_wave0_052046) * 3e5 ;doppler shift--km*s^-1, pos-away, neg-toward
PRINT, "limit_velocity_052046"
PRINT, N_ELEMENTS(limit_velocity_052046) ;2811
PRINT, limit_velocity_052046

;all velocity lines--40-1000 km/s
limit_all_e_dens_052046 = WHERE((limit_vel_width_052046 GE 40) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_052046 LT 1000) AND (limit_lw GE 0) AND (limit_sig_p_int GE 0) AND (limit_sig_lw GE 0) AND (ABS(limit_velocity_052046 LE (limit_gamma_052046/limit_wave0_052046) * 3e5)), COMPLEMENT = not_limit_all_e_dens_052046, count, /NULL)
PRINT, "limit_all_e_dens_052046--limit_vel_width"
PRINT, N_ELEMENTS(limit_vel_width_052046[limit_all_e_dens_052046])
PRINT, limit_vel_width_052046[limit_all_e_dens_052046] ;2811

PRINT, "limit_all_e_dens_052046--limit_p_int"
PRINT, N_ELEMENTS(limit_p_int[limit_all_e_dens_052046])
PRINT, limit_p_int[limit_all_e_dens_052046] ;2811

PRINT, "limit_all_e_dens_052046--limit_velocity"
PRINT, N_ELEMENTS(limit_velocity_052046[limit_all_e_dens_052046])
PRINT, ABS(limit_velocity_052046[limit_all_e_dens_052046]) ;2811

PRINT, "limit_all_e_dens_052046--limit_lw"
PRINT, N_ELEMENTS(limit_lw[limit_all_e_dens_052046])
PRINT, limit_lw[limit_all_e_dens_052046] ;2811

PRINT, "limit_all_e_dens_052046--limit_sig_p_int"
PRINT, N_ELEMENTS(limit_sig_p_int[limit_all_e_dens_052046])
PRINT, limit_sig_p_int[limit_all_e_dens_052046] ;2811

PRINT, "limit_all_e_dens_052046--limit_sig_lw"
PRINT, N_ELEMENTS(limit_sig_lw[limit_all_e_dens_052046])
PRINT, limit_sig_lw[limit_all_e_dens_052046] ;2811

;highest velocity lines--80-1000 km/s
limit_e_dens_052046 = WHERE((limit_vel_width_052046 GE 80) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_052046 LT 1000) AND (limit_lw GE 0) AND (limit_sig_p_int GE 0) AND (limit_sig_lw GE 0) AND (ABS(limit_velocity_052046 LE (limit_gamma_052046/limit_wave0_052046) * 3e5)), COMPLEMENT = not_limit_e_dens_052046, count, /NULL)
...
limit_70_80_e_dens_052046 = WHERE((limit_vel_width_052046 GE 70.0) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_052046 LT 80.0) AND (limit_lw GE 0.0) AND (limit_sig_p_int GE 0.0) AND (limit_sig_lw GE 0.0) AND (ABS(limit_velocity_052046 LE (limit_gamma_052046/limit_wave0_052046) * 3e5)), COMPLEMENT = not_limit_med_70_80_e_dens_052046, count, /NULL)
...
limit_40_50_e_dens_052046 = WHERE((limit_vel_width_052046 GE 40.0) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_052046 LT 50.0) AND (limit_lw GE 0.0) AND (limit_sig_p_int GE 0.0) AND (limit_sig_lw GE 0.0) AND (ABS(limit_velocity_052046 LE (limit_gamma_052046/limit_wave0_052046) * 3e5)), COMPLEMENT = not_limit_40_50_e_dens_052046, count, /NULL)
...
;SAVE, limit_all_e_dens_052046, limit_e_dens_052046, limit_70_80_e_dens_052046, limit_60_70_e_dens_052046, limit_50_60_e_dens_052046, limit_40_50_e_dens_052046, limit_vel_width_052046, limit_velocity_052046, p_int, sig_lw, lw, sig_p_int, FILENAME = sfname_UV_limit

;limit_e_dens_052046, limit_It_Si_052046, limit_int_int_unc_Si_052046, limit_70_80_e_dens_052046, limit_70_80_It_Si_052046, limit_70_80_int_int_unc_Si_052046, limit_60_70_e_dens_052046, limit_60_70_It_Si_052046, limit_60_70_int_int_unc_Si_052046, limit_50_60_e_dens_052046, limit_50_60_It_Si_052046, limit_50_60_int_int_unc_Si_052046, limit_40_50_e_dens_052046, limit_40_50_It_Si_052046, limit_40_50_int_int_unc_Si_052046

;===============================================================================
;calculate total integrated intensity

It_Si_052046 = (sqrt(2.0*!dpi)*p_int_052046*lw_052046) ;total integrated intensity 
PRINT, "It_Si_052046"
PRINT, It_Si_052046
PRINT, SIZE(It_Si_052046) ;1D,2811

;calculate integrated intensity uncertainty

int_int_unc_Si_052046 = [2.0*!dpi*((p_int_052046)^2*(sig_lw_052046)^2+(lw_052046)^2*(sig_p_int_052046)^2)]^0.5
PRINT, "int_int_unc_Si_052046"
PRINT, int_int_unc_Si_052046
PRINT, SIZE(int_int_unc_Si_052046) ;1D,2811

;save parameters from FOR loop

sfname_UV = '/Users/physicsuser/Desktop/amandabacon/REU_CfA/data/detection/052046/IT_UV_052046.sav'
SAVE, coeff_052046_UV, inst_unc_Si_052046, sigma_coeff, sigma_coeff_arr, coeff_arr_052046_UV, It_Si_052046, int_int_unc_Si_052046, limit_vel_width_052046, limit_velocity_052046, p_int_052046, sig_lw_052046, lw_052046, sig_p_int_052046, FILENAME = sfname_UV
...
limit_byte_scale_052046 = BYTSCL(coeff_arr_052046_clean, MIN = 5, MAX = 75, TOP = 254)

PRINT, SIZE(limit_byte_scale_052046[UVB_ind_052046[limit_p_int[limit_e_dens_052046]]]) ;1D 539
...
;limit_byte_scale_052046[UVB_ind_052046[limit_p_int[limit_e_dens_052046]]] = 255
limit_byte_scale_052046[UVB_ind_052046[limit_e_dens_052046]] = 255
...
PRINT, SIZE(REFORM(limit_byte_scale_052046)) ;2D 400,1093

PLOT_IMAGE, REFORM(limit_byte_scale_052046), ORIGIN = [SolarX1400_052046[0], SolarY1400_052046[0]], SCALE = [ResX1400_052046, ResY1400_052046], XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, /NOSCALE
...
limit_70_80_byte_scale_052046 = BYTSCL(coeff_arr_052046_clean, MIN = 5, MAX = 75, TOP = 254)

PRINT, SIZE(limit_70_80_byte_scale_052046[UVB_ind_052046[limit_p_int[limit_70_80_e_dens_052046]]]) ;1D 308

;DON'T DO THE COMMENTED OUT SECTION. THIS IS USING AN INDEX OF
;PEAK INTENSITY AND OUR coeff_arr_004121_clean IS ALREADY OF PEAK
;INTENSITY. THE UNCOMMENTED ONE MATCHES THE ONE CREATED IN
;master_table.pro FOR CHECKING PURSPOSES.
;limit_70_80_byte_scale_052046[UVB_ind_052046[limit_p_int[limit_70_80_e_dens_052046]]] = 255
limit_70_80_byte_scale_052046[UVB_ind_052046[limit_70_80_e_dens_052046]] = 255
...
PRINT, SIZE(REFORM(limit_70_80_byte_scale_052046)) ;2D 400,1093

PLOT_IMAGE, REFORM(limit_70_80_byte_scale_052046), ORIGIN = [SolarX1400_052046[0], SolarY1400_052046[0]], SCALE = [ResX1400_052046, ResY1400_052046], XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, /NOSCALE
...
limit_60_70_byte_scale_052046 = BYTSCL(coeff_arr_052046_clean, MIN = 5, MAX = 75, TOP = 254)

PRINT, SIZE(limit_60_70_byte_scale_052046[UVB_ind_052046[limit_p_int[limit_60_70_e_dens_052046]]]) ;1D 496

;DON'T DO THE COMMENTED OUT SECTION. THIS IS USING AN INDEX OF
;PEAK INTENSITY AND OUR coeff_arr_004121_clean IS ALREADY OF PEAK
;INTENSITY. THE UNCOMMENTED ONE MATCHES THE ONE CREATED IN
;master_table.pro FOR CHECKING PURSPOSES.
;limit_60_70_byte_scale_052046[UVB_ind_052046[limit_p_int[limit_60_70_e_dens_052046]]] = 255
limit_60_70_byte_scale_052046[UVB_ind_052046[limit_60_70_e_dens_052046]] = 255
...
PRINT, SIZE(REFORM(limit_60_70_byte_scale_052046)) ;2D 400,1093

PLOT_IMAGE, REFORM(limit_60_70_byte_scale_052046), ORIGIN = [SolarX1400_052046[0], SolarY1400_052046[0]], SCALE = [ResX1400_052046, ResY1400_052046], XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, /NOSCALE
...
limit_50_60_byte_scale_052046 = BYTSCL(coeff_arr_052046_clean, MIN = 5, MAX = 75, TOP = 254)

PRINT, SIZE(limit_50_60_byte_scale_052046[UVB_ind_052046[limit_p_int[limit_50_60_e_dens_052046]]]) ;1D 706

;DON'T DO THE COMMENTED OUT SECTION. THIS IS USING AN INDEX OF
;PEAK INTENSITY AND OUR coeff_arr_004121_clean IS ALREADY OF PEAK
;INTENSITY. THE UNCOMMENTED ONE MATCHES THE ONE CREATED IN
;master_table.pro FOR CHECKING PURSPOSES.
;limit_50_60_byte_scale_052046[UVB_ind_052046[limit_p_int[limit_50_60_e_dens_052046]]] = 255
limit_50_60_byte_scale_052046[UVB_ind_052046[limit_50_60_e_dens_052046]] = 255
...
PRINT, SIZE(REFORM(limit_50_60_byte_scale_052046)) ;2D 400,1093

PLOT_IMAGE, REFORM(limit_50_60_byte_scale_052046), ORIGIN = [SolarX1400_052046[0], SolarY1400_052046[0]], SCALE = [ResX1400_052046, ResY1400_052046], XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, /NOSCALE
...
limit_40_50_byte_scale_052046 = BYTSCL(coeff_arr_052046_clean, MIN = 5, MAX = 75, TOP = 254)

PRINT, SIZE(limit_40_50_byte_scale_052046[UVB_ind_052046[limit_p_int[limit_40_50_e_dens_052046]]]) ;1D 762

;DON'T DO THE COMMENTED OUT SECTION. THIS IS USING AN INDEX OF
;PEAK INTENSITY AND OUR coeff_arr_004121_clean IS ALREADY OF PEAK
;INTENSITY. THE UNCOMMENTED ONE MATCHES THE ONE CREATED IN
;master_table.pro FOR CHECKING PURSPOSES.
;limit_40_50_byte_scale_052046[UVB_ind_052046[limit_p_int[limit_40_50_e_dens_052046]]] = 255
limit_40_50_byte_scale_052046[UVB_ind_052046[limit_40_50_e_dens_052046]] = 255
...
PRINT, SIZE(REFORM(limit_40_50_byte_scale_052046)) ;2D 400,1093

PLOT_IMAGE, REFORM(limit_40_50_byte_scale_052046), ORIGIN = [SolarX1400_052046[0], SolarY1400_052046[0]], SCALE = [ResX1400_052046, ResY1400_052046], XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, /NOSCALE
...
SET_PLOT, 'ps'
DEVICE, XSIZE = 15, YSIZE = 10, /INCHES, COLOR = 1, BITS_PER_PIXEL = 8, SET_FONT = 'TIMES', /TT_FONT, FILENAME = '/Users/physicsuser/Desktop/amandabacon/REU_CfA/data/detection/052046/intensity_80_1000_UVB_052046.eps', /ENCAPSULATED
...
PLOT_IMAGE, REFORM(limit_byte_scale_052046), ORIGIN = [SolarX1400_052046[0], SolarY1400_052046[0]], SCALE = [ResX1400_052046, ResY1400_052046], XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, /NOSCALE, XTHICK = 10, YTHICK = 10, XCHARSIZE = 1.5, YCHARSIZE = 1.5, CHARSIZE = 1.5
...
;70-80 km/s velocity
SET_PLOT, 'ps'
DEVICE, XSIZE = 15, YSIZE = 10, /INCHES, COLOR = 1, BITS_PER_PIXEL = 8, SET_FONT = 'TIMES', /TT_FONT, FILENAME = '/Users/physicsuser/Desktop/amandabacon/REU_CfA/data/detection/052046/intensity_70_80_UVB_052046.eps', /ENCAPSULATED
...
PLOT_IMAGE, REFORM(limit_70_80_byte_scale_052046), ORIGIN = [SolarX1400_052046[0], SolarY1400_052046[0]], SCALE = [ResX1400_052046, ResY1400_052046], XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, /NOSCALE, XTHICK = 10, YTHICK = 10, XCHARSIZE = 1.5, YCHARSIZE = 1.5, CHARSIZE = 1.5
...
;60-70 km/s velocity
SET_PLOT, 'ps'
DEVICE, XSIZE = 15, YSIZE = 10, /INCHES, COLOR = 1, BITS_PER_PIXEL = 8, SET_FONT = 'TIMES', /TT_FONT, FILENAME = '/Users/physicsuser/Desktop/amandabacon/REU_CfA/data/detection/052046/intensity_60_70_UVB_052046.eps', /ENCAPSULATED
...
PLOT_IMAGE, REFORM(limit_60_70_byte_scale_052046), ORIGIN = [SolarX1400_052046[0], SolarY1400_052046[0]], SCALE = [ResX1400_052046, ResY1400_052046], XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, /NOSCALE, XTHICK = 10, YTHICK = 10, XCHARSIZE = 1.5, YCHARSIZE = 1.5, CHARSIZE = 1.5
...
;50-60 km/s velocity
SET_PLOT, 'ps'
DEVICE, XSIZE = 15, YSIZE = 10, /INCHES, COLOR = 1, BITS_PER_PIXEL = 8, SET_FONT = 'TIMES', /TT_FONT, FILENAME = '/Users/physicsuser/Desktop/amandabacon/REU_CfA/data/detection/052046/intensity_50_60_UVB_052046.eps', /ENCAPSULATED
...
PLOT_IMAGE, REFORM(limit_50_60_byte_scale_052046), ORIGIN = [SolarX1400_052046[0], SolarY1400_052046[0]], SCALE = [ResX1400_052046, ResY1400_052046], XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, /NOSCALE, XTHICK = 10, YTHICK = 10, XCHARSIZE = 1.5, YCHARSIZE = 1.5, CHARSIZE = 1.5
...
;40-50 km/s velocity
SET_PLOT, 'ps'
DEVICE, XSIZE = 15, YSIZE = 10, /INCHES, COLOR = 1, BITS_PER_PIXEL = 8, SET_FONT = 'TIMES', /TT_FONT, FILENAME = '/Users/physicsuser/Desktop/amandabacon/REU_CfA/data/detection/052046/intensity_40_50_UVB_052046.eps', /ENCAPSULATED
...
PLOT_IMAGE, REFORM(limit_40_50_byte_scale_052046), ORIGIN = [SolarX1400_052046[0], SolarY1400_052046[0]], SCALE = [ResX1400_052046, ResY1400_052046], XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, /NOSCALE, XTHICK = 10, YTHICK = 10, XCHARSIZE = 1.5, YCHARSIZE = 1.5, CHARSIZE = 1.5

COLORBAR, FORMAT = '(F0.2)', TITLE = "Intensity [Arbitrary Units]", RANGE = [5,75], /YLOG, YTICKS = 10, POSITION = [0.35,0.91,0.70,0.92], /TOP, CHARSIZE = 1.4

DEVICE, /CLOSE

;539+308+496+706+762=2811 (all UVBs)
