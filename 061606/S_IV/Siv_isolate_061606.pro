...
p_int = zero[coeff_arr_061606_Siv2_clean]
...
neg = -0.5
SNR_S_061606 = (((sig_p_int)^2/(p_int)^2)+((sig_lw)^2/(lw)^2))^neg
PRINT, SNR_S_061606

PRINT, SIZE(SNR_S_061606) ;352
SNR2_S_061606 = WHERE((SNR_S_061606 LT 100), count) ;removes infinity
