...
limit_vel_width_061606 = (coeff_arr_061606_UV[2,*,*]/limit_wave0_061606) * 3e5 * sqrt(2) ;exponential line width--km*s^-1
PRINT, "limit_vel_width_061606"
PRINT, N_ELEMENTS(limit_vel_width_061606) ;431
PRINT, limit_vel_width_061606

PRINT, 'TEST'
test = WHERE((limit_vel_width_061606 GE 0.0) AND (limit_vel_width_061606 LE 50.0), count)
PRINT, limit_vel_width_061606[test]
PRINT, MIN(limit_vel_width_061606[test]) ;40.184330

limit_velocity_061606 = ((coeff_arr_061606_UV[1,*,*]-limit_wave0_061606)/limit_wave0_061606) * 3e5 ;doppler shift--km*s^-1, pos-away, neg-toward
PRINT, "limit_velocity_061606"
PRINT, N_ELEMENTS(limit_velocity_061606) ;431
PRINT, limit_velocity_061606

;highest velocity lines--80-1000 km/s
limit_e_dens_061606 = WHERE((limit_vel_width_061606 GE 80) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_061606 LE 1000) AND (limit_lw GE 0) AND (limit_sig_p_int GE 0) AND (limit_sig_lw GE 0) AND (ABS(limit_velocity_061606 LE (limit_gamma_061606/limit_wave0_061606) * 3e5)), COMPLEMENT = not_limit_e_dens_061606, count)
...
limit_70_80_e_dens_061606 = WHERE((limit_vel_width_061606 GE 70.0) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_061606 LE 80.0) AND (limit_lw GE 0.0) AND (limit_sig_p_int GE 0.0) AND (limit_sig_lw GE 0.0) AND (ABS(limit_velocity_061606 LE (limit_gamma_061606/limit_wave0_061606) * 3e5)), COMPLEMENT = not_limit_med_70_80_e_dens_061606, count)
...
limit_60_70_e_dens_061606 = WHERE((limit_vel_width_061606 GE 60.0) AND (limit_p_int GE new_peak_min) AND (limit_vel_width_061606 LE 70.0) AND (limit_lw GE 0.0) AND (limit_sig_p_int GE 0.0) AND (limit_sig_lw GE 0.0) AND (ABS(limit_velocity_061606 LE (limit_gamma_061606/limit_wave0_061606) * 3e5)), COMPLEMENT = not_limit_60_70_e_dens_061606, count)
...
SAVE, limit_e_dens_061606, limit_It_Si_061606, limit_int_int_unc_Si_061606, limit_70_80_e_dens_061606, limit_70_80_It_Si_061606, limit_70_80_int_int_unc_Si_061606, limit_60_70_e_dens_061606, limit_60_70_It_Si_061606, limit_60_70_int_int_unc_Si_061606, limit_50_60_e_dens_061606, limit_50_60_It_Si_061606, limit_50_60_int_int_unc_Si_061606, limit_40_50_e_dens_061606, limit_40_50_It_Si_061606, limit_40_50_int_int_unc_Si_061606, FILENAME = sfname_UV_limit
