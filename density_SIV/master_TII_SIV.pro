...
num_three = WHERE((t_S_004121 GT 3.0), count)

num_three = WHERE((SNR_S_004121[SNR2_S_004121] GT 3.0), count)
PRINT, SIZE(num_three) ;8
...
num2_three = WHERE((t_S_050655 GT 3.0), count)

num2_three = WHERE((SNR_S_050655[SNR2_S_050655] GT 3.0), count)
PRINT, SIZE(num2_three) ;11
...
num3_three = WHERE((SNR_S_050655_1[SNR2_S_050655_1] GT 3.0), count)
PRINT, SIZE(num3_three) ;3
...
num5_three = WHERE((SNR_S_061606[SNR2_S_061606] GT 3.0), count)
PRINT, SIZE(num5_three) ;5
...
num6_three = WHERE((SNR_S_114951[SNR2_S_114951] GT 3.0), count)
PRINT, SIZE(num6_three) ;52
...
num7_three = WHERE((SNR_S_122033[SNR2_S_122033] GT 3.0), count)
PRINT, SIZE(num7_three) ;38
...
num8_three = WHERE((SNR_S_160806[SNR2_S_160806] GT 3.0), count)
PRINT, SIZE(num8_three) ;19
...
num9_three = WHERE((SNR_S_163205[SNR2_S_163205] GT 3.0), count)
PRINT, SIZE(num9_three) ;9
...
num10_three = WHERE((SNR_S_174905[SNR2_S_174905] GT 3.0), count)
PRINT, SIZE(num10_three) ;54
...
num11_three = WHERE((SNR_S_181205[SNR2_S_181205] GT 3.0), count)
PRINT, SIZE(num11_three) ;10
...
num12_three = WHERE((SNR_S_201925[SNR2_S_201925] GT 3.0), count)
PRINT, SIZE(num12_three) ;15
...
num13_three = WHERE((SNR_S_201925_1[SNR2_S_201925_1] GT 3.0), count)
PRINT, SIZE(num13_three) ;5
...
num14_three = WHERE((SNR_S_203906[SNR2_S_203906] GT 3.0), count)
PRINT, SIZE(num14_three) ;50
...
num15_three = WHERE((SNR_S_215426[SNR2_S_215426] GT 3.0), count)
PRINT, SIZE(num15_three) ;3
...
num16_three = WHERE((SNR_S_232931[SNR2_S_232931] GT 3.0), count)
PRINT, SIZE(num16_three) ;1
...
PRINT, N_ELEMENTS(It_Si_052046[num4_three]) ;444
